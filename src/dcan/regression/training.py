...
from dcan.inference.make_predictions import (
...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--tb-prefix", default="loes_scoring", help="Tensorboard data prefix."
        )
...
class LoesScoringTrainingApp:
    ...
    def split_train_validation(self):
        ...
        if (
            ...
            validation_users = list(
                set(validation_rows["anonymized_subject_id"].to_list())
            )
    ...
    def _stratified_split(self, all_subjects):
        ...
        try:
            ...
            mean_values = self.input_df.groupby("anonymized_subject_id")[
                "loes-score"
            ].mean()
