...
model_save_location = "/home/feczk001/shared/data/AlexNet/LoesScoring/loes_scoring_02.pt"
...
trainingApp = LoesScoringTrainingApp()
val_dl = trainingApp.init_val_dl("/home/miran045/reine097/projects/loes-scoring-2/data/MNI-space_Loes_data.csv")
batch_iter = enumerateWithEstimate(val_dl, "captum")
for batch_ndx, batch_tup in batch_iter:
    input, label_t = batch_tup
