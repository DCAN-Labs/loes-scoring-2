...
```{r}
scan_reg_n4_brain = '/home/feczk001/shared/projects/S1067_Loes/data/Fairview-ag/anonymized/processed/sub-01_ses-01_space-MNI_brain_mprage.nii.gz'
img = readNIfTI(scan_reg_n4_brain)
print(img)
```
