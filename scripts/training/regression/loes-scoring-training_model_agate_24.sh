...
/users/9/reine097/projects/loes-scoring-2/.venv/bin/python \
  ...
  --csv-input-file "/users/9/reine097/projects/loes-scoring-2/data/anon_train_scans_and_loes_training_test_non_gd.csv" \
                        ...
                        --model-save-location "/home/feczk001/shared/data/LoesScoring/loes_scoring_24.pt" \
                        --gd  0 \
                        --folder "/home/feczk001/shared/projects/S1067_Loes/data/Fairview-ag/05-training_ready/" \
                        --csv-output-file "/users/9/reine097/projects/loes-scoring-2/doc/models/model24/model24.csv" \
                        --plot-location "/users/9/reine097/projects/loes-scoring-2/doc/models/model24/model24.png"  \
                        --model "resnet" \
                        --epochs 200
