...
/users/9/reine097/projects/loes-scoring-2/.venv/bin/python \
  ...
  --csv-data-file "/users/9/reine097/projects/loes-scoring-2/data/anon_train_scans_and_loes_training_test_non_gd.csv" \
                        ...
                        --model-save-location "/home/feczk001/shared/data/AlexNet/LoesScoring/loes_scoring_12_512.pt" \
                        --output-csv-file  "/users/9/reine097/projects/loes-scoring-2/data/filtered/model12_out_512.csv" \
                        --gd  0 \
                        --folder "/home/feczk001/shared/projects/S1067_Loes/data/Fairview-ag/05-training_ready/" \
                        --use-train-validation-cols \
                        --csv-output-file "/users/9/reine097/projects/loes-scoring-2/doc/models/model12/model12_512.csv" \
                        --plot-location "/users/9/reine097/projects/loes-scoring-2/doc/models/model12/model12_512.png"
