...
/users/9/reine097/projects/loes-scoring-2/.venv/bin/python \
  ...
  --csv-input-file "/users/9/reine097/projects/loes-scoring-2/data/regression_training_validation.csv" \
                        ...
                        --model-save-location "/home/feczk001/shared/data/LoesScoring/loes_scoring_26.pt" \
                        --gd  0 \
                        --folder "/home/feczk001/shared/projects/S1067_Loes/data/Fairview-ag/05-training_ready/" \
                        --csv-output-file "/users/9/reine097/projects/loes-scoring-2/doc/models/model26/model26.csv" \
                        --plot-location "/users/9/reine097/projects/loes-scoring-2/doc/models/model26/model26.png"  \
                        --model "ResNet" \
                        --lr 0.0001 \
                        --scheduler 'onecycle' \
