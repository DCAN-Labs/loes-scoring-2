...
/users/9/reine097/projects/loes-scoring-2/.venv/bin/python \
  ...
  --csv-data-file "/users/9/reine097/projects/loes-scoring-2/data/anon_train_scans_and_loes_training_test_non_gd.csv" \
                        ...
                        --model-save-location "/home/feczk001/shared/data/AlexNet/LoesScoring/loes_scoring_13_512.pt" \
                        --output-csv-file  "/users/9/reine097/projects/loes-scoring-2/data/filtered/model13_out_512.csv" \
                        --gd  0 \
