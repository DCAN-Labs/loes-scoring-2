...
/home/miran045/reine097/projects/AlexNet_Abrol2021/venv/bin/python \
  ...
  --csv-data-file "/home/miran045/reine097/projects/loes-scoring-2/data/filtered/ashish_all_low_loes_scores.csv" \
  --batch-size 1 --num-workers 1 --epochs 256 \
  --model-save-location "/home/feczk001/shared/data/AlexNet/LoesScoring/loes_scoring_11.pt" \
  --output-csv-file "/home/miran045/reine097/projects/loes-scoring-2/doc/models/model11/output.csv" --gd 2 \
  --plot-location "/home/miran045/reine097/projects/loes-scoring-2/doc/models/model11/correlation.png" --use-train-validation-cols
