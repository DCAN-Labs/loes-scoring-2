...
/home/miran045/reine097/projects/AlexNet_Abrol2021/venv/bin/python \
  /home/miran045/reine097/projects/loes-scoring-2/src/dcan/training/training_leave_out_n_cross_validation.py \
  --csv-data-file "/home/miran045/reine097/projects/loes-scoring-2/data/filtered/ashish_all.csv" --batch-size 1 \
  --num-workers 1 --epochs 128 \
  --model-save-location "/home/feczk001/shared/data/AlexNet/LoesScoring/loes_scoring_model_1_cv" \
  --output-csv-folder "/home/miran045/reine097/projects/loes-scoring-2/data/filtered/model01_out_cv"
